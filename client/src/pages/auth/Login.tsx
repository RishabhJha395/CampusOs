...
export function Login() {
  ...
  // Try to go back to where they came from, else dashboard
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ProtectedRoute and useAuthSession will handle the redirection naturally once the session is set
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full appearance-none rounded-xl border border-gray-300 dark:border-gray-700 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                />
              </div>
            </div>
